...
/*   Updated: 2024/03/17 01:14:13 by bhildebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ensure(t_i32 condition, void (*callback)(void));
...
void	call_in_range_with_data(
			...
			void *data);
void	call_until(void (*callback)(void));
void	call_until_with_data(void (*callback)(void *), void *data);
